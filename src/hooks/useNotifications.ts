...
export const useNotifications = () => {
  ...
  const addGoalNotification = useCallback((goalTitle: string, activityName: string, progress: number, activityId?: string, goalId?: string) => {
  ...
  const addWarningNotification = useCallback((title: string, message: string, activityId?: string) => {
    return addNotification('warning', title, message, activityId);
  }, [addNotification]);

  const addInfoNotification = useCallback((title: string, message: string, activityId?: string) => {
    return addNotification('info', title, message, activityId);
  }, [addNotification]);

  const addErrorNotification = useCallback((title: string, message: string, activityId?: string) => {
